...
a = input('Masukkan a11: ')
b= float(a)
c = input('Masukkan a12  : ')
d= float(c)
aku = input('Masukkan a13  : ')
kamu= float(aku)
z = input('Masukkan Constanta : ')
konstanta= float(z)
...
print("\n=====PERSAMAAN 2=====\n")
e = input('Masukkan a21: ')
f= float(e)
g = input('Masukkan a22  : ')
h= float(g)
aku1 = input('Masukkan a23  : ')
kamu1= float(aku1)
w = input('Masukkan Constanta : ')
konstanta1= float(w)

print("\n=====PERSAMAAN 3=====\n")
i = input('Masukkan a31: ')
j= float(i)
k = input('Masukkan a32  : ')
l= float(k)
aku2 = input('Masukkan a33  : ')
kamu2= float(aku2)
m = input('Masukkan Constanta : ')
konstanta2= float(m)
